...
local RadarInfo = {
    ...
    PlayerDot = Color3.fromRGB(0, 255, 0), -- Define a cor como verde
    Health_Color = true,
    Team_Check = false -- Desativar verificação de equipe
}
    ...
    local function Update()
        ...
        c = game:service("RunService").RenderStepped:Connect(function()
            ...
            if char and char:FindFirstChildOfClass("Humanoid") and char.PrimaryPart ~= nil and char:FindFirstChildOfClass("Humanoid").Health > 0 then
                ...
                PlayerDot.Color = RadarInfo.PlayerDot -- Define a cor como verde
