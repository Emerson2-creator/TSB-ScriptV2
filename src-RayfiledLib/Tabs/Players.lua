...
-- Codigo para mostrar as informações dos players (Pasta: Scripts/PlayersTabScripts/ShowInfoAboutPlayers.lua)
...
-- Criando um toggle com um script ESP para mostrar os players (Pasta: Scripts/PlayersTabScripts/ESP.lua)
